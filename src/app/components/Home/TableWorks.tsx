    ...
    <div className="bg-white flex-col min-w-min min-h-48 items-center justify-center p-4 rounded-lg shadow-md">
      ...
      <div className="flex justify-center items-center pt-4">
        <Link href={link} target="_blank">
          <button type="button" className=" text-white bg-dark0 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-2xl text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-dark0 dark:hover:bg-gray-900  transition duration-200 dark:focus:ring-gray-900 dark:border-gray-900">
